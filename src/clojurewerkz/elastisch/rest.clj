...
(defn search-url
  ...
  * 1-arity form constructs a URI that searches across all indexes and all mappings
  * 2-arity form constructs a URI for one or more indexes and all mappings in them.
  * 3-arity form constructs a URI for one or more indexes and given mappings in them.
