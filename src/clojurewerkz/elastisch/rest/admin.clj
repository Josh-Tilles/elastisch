...
(defn cluster-health
  "see https://www.elastic.co/guide/en/elasticsearch/reference/1.7/cluster-health.html
...
(defn cluster-state
  "see https://www.elastic.co/guide/en/elasticsearch/reference/1.7/cluster-state.html
...
(defn nodes-stats
  "see https://www.elastic.co/guide/en/elasticsearch/reference/1.7/cluster-nodes-stats.html
...
(defn nodes-info
  "see https://www.elastic.co/guide/en/elasticsearch/reference/1.7/cluster-nodes-info.html
